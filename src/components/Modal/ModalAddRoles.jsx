...
const ModalAddRoles = ({ isOpen, onClose }) => {
  const [formData, setFormData] = useState({ nama: "" }); // Default state dengan properti `nama`
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${apiUrl}/roles`, { nama: formData.nama });
